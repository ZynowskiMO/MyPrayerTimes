...
local PALETTES = {
  light = {
    ...
    wizHeader  = { 0.30, 0.22, 0.12, 1 }, -- wizard's warm brown title bar
    dotOff     = { 0.70, 0.66, 0.58, 1 }, -- inactive step dot
    sidebar    = { 0.91, 0.88, 0.81, 1 },
    navHl      = { 0.97, 0.95, 0.90, 1 },
    navText    = { 0.16, 0.14, 0.11, 1 }, -- sidebar item title
    navSub     = { 0.45, 0.42, 0.36, 1 }, -- sidebar item subtitle
  ...
  dark = {
    ...
    wizHeader  = { 0.12, 0.09, 0.05, 1 },
    dotOff     = { 0.40, 0.38, 0.34, 1 },
    sidebar    = { 0.10, 0.09, 0.08, 1 },
    navHl      = { 0.20, 0.18, 0.15, 1 },
    navText    = { 0.90, 0.87, 0.80, 1 },
    navSub     = { 0.62, 0.58, 0.50, 1 },
